...
X(vehicle_param.n_dofs+1,1)=inputs.V0;
X(vehicle_param.n_dofs+4,1)=inputs.V0/vehicle_param.r_w;
X(vehicle_param.n_dofs+5,1)=inputs.V0/vehicle_param.r_w;
X(vehicle_param.n_dofs+6,1)=inputs.V0/vehicle_param.r_w;
X(vehicle_param.n_dofs+7,1)=inputs.V0/vehicle_param.r_w;
